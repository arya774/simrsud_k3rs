    ...
    <div class="card main-card">
        ...
        <div class="card-body p-4">
            ...
            <form id="formInspeksi"
                  action="<?php echo e(route('inspeksi.store')); ?>"
                  method="POST">
                ...
                <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="kategori-card">
                        ...
                        <div class="kategori-header"
                            ...
                            <h5><?php echo e(strtoupper($kategori->nama_kategori)); ?></h5>

                            <span id="icon-<?php echo e($kategori->id); ?>"
                        ...
                        <div class="kategori-body"
                            ...
                            <div class="catatan-kategori">
                                <h6>Catatan <?php echo e($kategori->nama_kategori); ?></h6>

                                <textarea
                                    name="catatan_kategori[<?php echo e($kategori->id); ?>]"
                                    class="form-control"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\Documents\Project\RSUD\belajar ni\simrsud_k3rs\resources\views/inspeksi/index.blade.php ENDPATH**/ ?>